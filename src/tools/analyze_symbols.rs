...
impl AnalyzeSymbolContextTool {
    ...
    pub async fn call_tool(
        ...
        info!(
            "🔍 AnalyzeSymbolContextTool::call_tool() - Starting analysis: symbol='{}', location={:?}, include_usage_patterns={}, include_inheritance={}, include_call_hierarchy={}, build_directory={:?}",
            self.symbol,
            self.location,
        ...
        // Handle build directory parameter or automatic build directory resolution
